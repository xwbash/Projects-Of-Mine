...
TournamentJoinPopup* TournamentJoinPopup::setup(FormattedStringBuilder infoTextBuilder)
{
    popupName = "TournamentJoinPopup";
    isFullScreen = false;
    ...
    auto backgroundSprite = Sprite::create(RemoteTournamentManager::getInstance()->getJoinBgPath());
    ...
    auto desc = HBLabel::create(infoTextBuilder, FONTS::USE_LOCALIZATION, width * .035f);
    ...
    getButton->button->onTap([](){
        ...
        RemoteTournamentManager::getInstance()->joinTournament();
    });
...
void TournamentJoinPopup::onExit()
{
